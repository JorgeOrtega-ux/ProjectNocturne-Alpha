<div class="menu-component disabled body-title" data-menu="timer">
                        ...
                        <div class="menu-content">
                            <div class="menu-content-header">
                                <div class="menu-content-header-primary">
                                    ...
                                    <span data-translate="section" data-translate-category="general">Section</span>
                                </div>
                            </div>
                            <div class="menu-content-general">
                                <div class="custom-select-content" data-action="open-create-section-menu" data-context="timer">
                                    <div class="custom-select-content-left">
                                        <span id="timer-selected-section" data-translate="my_timers" data-translate-category="timer">My Timers</span>
                                    </div>
                                    <div class="custom-select-content-right">
                    ...
                    <div class="menu-content-wrapper disabled" data-tab-content="count_to_date">
                        ...
                        <div class="menu-content">
                            ...
                            <div class="menu-content-general">
                                <div class="custom-select-content" data-action="open-create-section-menu" data-context="timer">
                                    <div class="custom-select-content-left">
                                        <span id="timer-selected-section-date" data-translate="my_timers" data-translate-category="timer">My Timers</span>
                                    </div>
                                    <div class="custom-select-content-right">
                                        <span class="material-symbols-rounded">arrow_right</span>
                                    </div>
                                ...
                                <div class="date-time-content">
                                    ...
                                    <div class="date-time-selector">
                                        <div class="custom-select-content" data-action="open-time-picker-menu">
                                            <div class="custom-select-content-left">
                                                <span id="selected-hour-display">--</span> : <span id="selected-minute-display">--</span>
                                            </div>
