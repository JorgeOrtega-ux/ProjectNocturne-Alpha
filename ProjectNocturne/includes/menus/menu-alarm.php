<div class="menu-component disabled body-title" data-menu="alarm">
                ...
                <div class="menu-section-center overflow-y">
                    <div class="menu-content-wrapper active">
                        ...
                        <div class="menu-content">
                            ...
                            <div class="menu-content-general">
                                <div class="custom-select-content" data-action="open-create-section-menu" data-context="alarm">
                                    <div class="custom-select-content-left">
                                        <span id="alarm-selected-section" data-translate="my_alarms" data-translate-category="alarms">My Alarms</span>
                                    </div>
